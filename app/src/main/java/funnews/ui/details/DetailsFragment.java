...
public class DetailsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // The free API only provide small part of the whole news text.
        // We duplicate more text to make it look beautiful. Will optimize later.
        ...
        text += text;
        text = text.replace("\n", "");
        binding.detailsContentTextView.setText(text);
